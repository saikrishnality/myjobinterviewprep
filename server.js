...
2. Professional Summary — full rewrite using JD vocabulary
   ...
   Paragraph 1: Who you are, years of experience, core strength, key metrics (2-3 sentences max)
   Write this in first or third person as a factual statement about the candidate.

   Paragraph 2: What the candidate brings to THIS company and role (2-3 sentences max)
   STRICT RULES FOR PARAGRAPH 2:
   - NEVER write as if the candidate already works at the target company
   - NEVER say "for [company]" or "at [company]" when describing past achievements
   - Past work was done at PREVIOUS employers — make this clear
   - Frame it as: "brings X experience" or "has delivered X which directly applies to Y"
   - Correct: "Brings hands-on experience running flagship conferences at Oracle Cloud World and AWS re:Invent — directly applicable to PingCAP's developer community events"
   - Wrong: "Distinctively positioned for PingCAP through hands-on ownership of flagship conferences at Oracle Cloud World" — this implies the events were run for PingCAP

   Do not merge into one block. Two clear paragraphs.
   IMPORTANT: Complete both paragraphs fully. Do not truncate or trail off mid-sentence.
...
Paragraph 1: Who the candidate is, experience, key metrics. Factual.
Paragraph 2: What the candidate BRINGS to this company from their PAST experience.
- NEVER write as if the candidate already works at the target company
- NEVER say "for [company]" or "at [company]" when describing past work
- Past achievements were done at PREVIOUS employers — keep this clear
- Correct: "Brings X years of experience in Y which directly maps to what [company] needs"
- Wrong: "Positioned for [company] through hands-on work at..." — implies they did that work FOR the company
